...
//////// Your Code ////////
  NetDeviceContainer allDevices;
    ...
    PointToPointHelper pointToPoint; // Loop 전에 선언
...
// 4. Create P2P links and set attributes

//////// Your Code ////////

    // 0->1, 1->2, ..., 5->0 순서로 연결
  for (uint32_t i = 0; i < 6; ++i) {
      uint32_t nextNode = (i + 1) % 6;
      
      // 링크 생성
      NodeContainer linkNodes (nodes.Get(i), nodes.Get(nextNode));
      NetDeviceContainer linkDevices = pointToPoint.Install (linkNodes);
      
      // 관리용 컨테이너에 추가
      allDevices.Add (linkDevices);

      // 서브넷 할당 (10.1.1.0 ~ 10.1.6.0)
...
// 5-1. Application for delay test
  ...
  //////// Your Code ////////
  UdpEchoClientHelper echoClient1 (Ipv4Address ("10.1.2.2"), 9);
...
// 5-2. Application for throughput test 
  ...
  //////// Your Code ////////
  UdpEchoClientHelper echoClient1 (Ipv4Address ("10.1.3.2"), 9);
  ...
  //////// Your Code ////////
  ApplicationContainer serverApps3 = echoServer3.Install (nodes.Get (5));
  ...
  //////// Your Code ////////
  UdpEchoClientHelper echoClient3 (Ipv4Address ("10.1.5.2"), 11);
